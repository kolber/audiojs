...
trackLoadProgress:function(b){if(b.settings.preload){var a,c;b=b;var d=/(ipod|iphone|ipad)/i.test(navigator.userAgent);a=setInterval(function(){if(b.element.readyState>-1)d||b.init.apply(b);if(b.element.readyState>1){b.settings.autoplay&&b.play.apply(b);clearInterval(a);c=setInterval(function(){b.loadProgress.apply(b);b.loadedPercent>=1&&clearInterval(c)})}},10);b.readyTimer=a;b.loadTimer=c}},purge:function(b){var a=b.attributes,c;if(a)for(c=0;c<a.length;c+=1)if(typeof b[a[c].name]==="function")b[a[c].name]=
null;if(a=b.childNodes)for(c=0;c<a.length;c+=1)purge(b.childNodes[c])},ready:function(){return function(b){var a=window,c=false,d=true,e=a.document,k=e.documentElement,h=e.addEventListener?"addEventListener":"attachEvent",n=e.addEventListener?"removeEventListener":"detachEvent",q=e.addEventListener?"":"on",p=function(o){if(!(o.type=="readystatechange"&&e.readyState!="complete")){(o.type=="load"?a:e)[n](q+o.type,p,false);if(!c&&(c=true))b.call(a,o.type||o)}},t=function(){try{k.doScroll("left")}catch(o){setTimeout(t,
