...
var a=new b.constructor,c;for(c in b)a[c]=arguments.callee(b[c]);return a},addClass:function(b,a){RegExp("(\\s|^)"+a+"(\\s|$)").test(b.className)||(b.className+=" "+a)},removeClass:function(b,a){b.className=b.className.replace(RegExp("(\\s|^)"+a+"(\\s|$)")," ")},injectCss:function(b,a){var c=document.getElementsByTagName("head")[0],d=c.firstChild,e=document.createElement("style"),k=a.replace(/\$1/g,b.settings.imageLocation);if(c){for(var m="",n=document.getElementsByTagName("style"),o=0,s=n.length;o<
s;o++){var r=n[o].getAttribute("title");if(r&&~r.indexOf("audiojs")){e=n[o];m=e.innerHTML;break}}e.setAttribute("type","text/css");e.setAttribute("title","audiojs");if(e.styleSheet)e.styleSheet.cssText=m+k;else e.appendChild(document.createTextNode(m+k));d?c.insertBefore(e,d):c.appendChild(styleElement)}},cloneHtml5Node:function(b){var a=document.createDocumentFragment();a.createElement("audio");var c=a.createElement("div");a.appendChild(c);c.innerHTML=b.outerHTML;return c.firstChild},getSwf:function(b){b=
